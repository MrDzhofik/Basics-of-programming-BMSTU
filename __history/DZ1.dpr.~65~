...
begin
     ...
     writeln('Абсолютная погрешность:', exact:20:16);
     writeln('Относительная погрешность:', otn:20:16);
     readln;
end.
...
//    Writeln('Абсолютная погрешность =', delta:20:16);
//    Writeln('Относительная погрешность =', otn:20:16);
//    readln;
...
//    y1 := (exp(x) - exp(-x)) / 2;
  ...
  //    a := 1;
  //    y := 1;
  //    WriteLn('До преобразований y=',y:18:16);
  //    y := y / 6000;
  //    y := exp(y);                  {y = e^x}
  ...
  //    y := ln(y);
  //    y := 6000 * y;
  //  WriteLn('После преобразований y =', y:18:16);
//end.
